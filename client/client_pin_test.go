...
func TestPinLsIndirect(t *testing.T) {
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	var err error
...
func TestPinLsPrecedence(t *testing.T) {
	...
	t.Run("TestPinLsPredenceRecursiveIndirect", TestPinLsPredenceRecursiveIndirect)
	t.Run("TestPinLsPrecedenceDirectIndirect", TestPinLsPrecedenceDirectIndirect)
	t.Run("TestPinLsPrecedenceRecursiveDirect", TestPinLsPrecedenceRecursiveDirect)
}

// TestPinLsPredenceRecursiveIndirect ...
func TestPinLsPredenceRecursiveIndirect(t *testing.T) {
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	var err error
...
// TestPinLsPrecedenceDirectIndirect ...
func TestPinLsPrecedenceDirectIndirect(t *testing.T) {
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	var err error
...
// TestPinLsPrecedenceRecursiveDirect ...
func TestPinLsPrecedenceRecursiveDirect(t *testing.T) {
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	var err error
...
// TestPinIsPinned ...
func TestPinIsPinned(t *testing.T) {
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
	var err error
